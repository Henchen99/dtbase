...
const topics = [
    ...
    //Form and function^^^
    { "name": "Arts & Crafts", "url": "notes_pages/design_influences_methods_and_figures_factors_influencing_the_development_of_products_notes.html#ArtsCrafts" },
    { "name": "Art Nouveau", "url": "notes_pages/design_influences_methods_and_figures_factors_influencing_the_development_of_products_notes.html#ArtNouveau" },
    { "name": "Bauhaus Modernist", "url": "notes_pages/design_influences_methods_and_figures_factors_influencing_the_development_of_products_notes.html#BauhausModernist" },
    { "name": "Art Deco", "url": "notes_pages/design_influences_methods_and_figures_factors_influencing_the_development_of_products_notes.html#ArtDeco" },
    { "name": "Post Modernism", "url": "notes_pages/design_influences_methods_and_figures_factors_influencing_the_development_of_products_notes.html#PostModernism" },
    { "name": "Streamlining", "url": "notes_pages/design_influences_methods_and_figures_factors_influencing_the_development_of_products_notes.html#Streamlining" },
    { "name": "Memphis", "url": "notes_pages/design_influences_methods_and_figures_factors_influencing_the_development_of_products_notes.html#Memphis" },
    { "name": "William Morris", "url": "notes_pages/design_influences_methods_and_figures_factors_influencing_the_development_of_products_notes.html#WilliamMorris" },
    { "name": "Charles Rennie Mackintosh", "url": "notes_pages/design_influences_methods_and_figures_factors_influencing_the_development_of_products_notes.html#CharlesRennieMackintosh" },
    { "name": "Marianna Brandt", "url": "notes_pages/design_influences_methods_and_figures_factors_influencing_the_development_of_products_notes.html#MariannaBrandt" },
    { "name": "Eileen Gray", "url": "notes_pages/design_influences_methods_and_figures_factors_influencing_the_development_of_products_notes.html#EileenGray" },
    { "name": "Philippe Starck", "url": "notes_pages/design_influences_methods_and_figures_factors_influencing_the_development_of_products_notes.html#PhilippeStarck" },
    { "name": "Raymond Lowey", "url": "notes_pages/design_influences_methods_and_figures_factors_influencing_the_development_of_products_notes.html#RaymondLowey" },
    { "name": "Ettore Scotsass", "url": "notes_pages/design_influences_methods_and_figures_factors_influencing_the_development_of_products_notes.html#EttoreScotsass" },
    //Design theory^^^
